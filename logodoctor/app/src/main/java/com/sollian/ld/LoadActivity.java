...
import com.sollian.ld.svgtools.GAStudioPath;
...
public class LoadActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAnimatedSvgView.setFillPaints(new int[]{210}, new int[]{00},
                new int[]{180}, new int[]{00});
        ...
        mReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ViewHelper
                        .setTranslationY(mAnimatedSvgView, mInitialLogoOffset);
                mSubtitleView.setVisibility(View.INVISIBLE);
                    ...
                    public void onStateChange(int state) {
                        if (state == AnimatedSvgView.STATE_FILL_STARTED) {
                            ...
                            ObjectAnimator a1 = ObjectAnimator.ofFloat(
                                    mAnimatedSvgView, "translationY", 0);
                            ObjectAnimator a2 = ObjectAnimator.ofFloat(
                                    mSubtitleView, "alpha", 1);
